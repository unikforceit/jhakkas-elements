...
class jhakkas_service3 extends Widget_Base {

    public function get_name() {
        return 'jhakkas-service3';
    }

    public function get_title() {
        return esc_html__('Jhakkas Service 3', 'jhakkas');
    }
    ...
    protected function _register_controls() {
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .service-layout3 .service-box3' => 'width: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .service-layout3 .service-box3' => 'height: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .service-layout3 .service-box3 .service3-title',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .service-layout3 .service-box3 .service3-title' => 'color: {{VALUE}};',
                ],
            ]
        );
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .service-layout3 .service-box3 .service3-text',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' =>  \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .service-layout3 .service-box3 .service3-text' => 'color: {{VALUE}};',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .service-layout3 .service-box3 .service3-icon i' => 'font-size: {{SIZE}}{{UNIT}};',
                    '{{WRAPPER}} .service-layout3 .service-box3 .service3-icon svg' => 'width: {{SIZE}}{{UNIT}}; height: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'type' =>  \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .service-layout3 .service-box3 .service3-icon i' => 'color: {{VALUE}};',
                    '{{WRAPPER}} .service-layout3 .service-box3 .service3-icon svg' => 'fill: {{VALUE}};',
                ],
            ]
        );
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .service-layout3 .service-box3 .service3-btn a',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' =>  \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .service-layout3 .service-box3 .service3-btn a' => 'color: {{VALUE}};',
                ],
            ]
        );
        $normal_selector = '{{WRAPPER}} .service-layout3 .service-box3';
        $this->add_group_control(
        ...
        $hover_selector = '{{WRAPPER}} .service-layout3 .service-box3:hover';
        ...
        $this->add_control(
            ...
            [
                ...
                'type' =>  \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .service-layout3 .service-box3:hover .service3-title' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' =>  \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .service-layout3 .service-box3:hover .service3-text' => 'color: {{VALUE}};',
                ],
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'type' =>  \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .service-layout3 .service-box3:hover .service3-icon i' => 'color: {{VALUE}};',
                    '{{WRAPPER}} .service-layout3 .service-box3:hover .service3-icon svg' => 'fill: {{VALUE}};',
                ],
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'type' =>  \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .service-layout3 .service-box3:hover .service3-btn a' => 'color: {{VALUE}};',
                ],
            ]
        );
        $this->add_group_control(
...
$widgets_manager->register_widget_type(new \JhakkasElements\Widgets\jhakkas_service3());